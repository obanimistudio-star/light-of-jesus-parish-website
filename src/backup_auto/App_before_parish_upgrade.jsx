...
import obanimiLogo from "./assets/ObanimiStudio_App_Brand_Logo.jpg";
  ...
  return (
    <div className="app">
      ...
      <header className="top-header">
        <img
          src={choirLogo}
          alt="Light of Jesus Parish Choir Logo"
        ...
        <h1 className="choir-name">
          Light of Jesus Parish 
        </h1>
      </header>
      ...
      <main className="main-shell">
        <section id="home" className="section">
          <div className="hero-panel">
            ...
            <p className="lead-text">
              Connect, worship, learn and fellowship
              together.
            </p>
        ...
        >
          ...
          <p className="section-intro">
            ...
            programmes and special choir events.
          </p>
      ...
      <footer className="footer">
        ...
        <div className="footer-tagline">
          Creating with Purpose. Inspiring through
          Faith.
        </div>
      </footer>
    </div>
